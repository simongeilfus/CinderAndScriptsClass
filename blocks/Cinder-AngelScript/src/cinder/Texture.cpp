...
namespace as {
	...
	void registerCinderTextureFormatImpl( asIScriptEngine* engine, bool useNamespaces )
	{
		...
		r = engine->RegisterObjectBehaviour( "Format", asBEHAVE_CONSTRUCT,
			"void f()", asFUNCTION( as::BindingHelper::constructor<Texture::Format>), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// Destructor
		r = engine->RegisterObjectBehaviour( "Format", asBEHAVE_DESTRUCT,
			"void f()", asFUNCTION(as::BindingHelper::destructor<Texture::Format>), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// Copy Constructor
		r = engine->RegisterObjectBehaviour( "Format", asBEHAVE_CONSTRUCT,
			"void f(const Format &in )", asFUNCTION( ( as::BindingHelper::constructor<Texture::Format,const Texture::Format &> ) ), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// Copy Assignement
		r = engine->RegisterObjectMethod( "Format","Format& opAssign(const Format &in)", asFUNCTION((as::BindingHelper::opAssign<Texture::Format&,Texture::Format,Texture::Format&>)), asCALL_CDECL_OBJLAST); assert( r >= 0 );
	...
	void registerCinderTextureImpl( asIScriptEngine* engine, bool useNamespaces )
	{
		...
		r = engine->RegisterObjectBehaviour( "Texture", asBEHAVE_CONSTRUCT,
			"void f()", asFUNCTION( as::BindingHelper::constructor<Texture>), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// Destructor
		r = engine->RegisterObjectBehaviour( "Texture", asBEHAVE_DESTRUCT,
			"void f()", asFUNCTION(as::BindingHelper::destructor<Texture>), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// Copy Constructor
		r = engine->RegisterObjectBehaviour( "Texture", asBEHAVE_CONSTRUCT,
			"void f(const Texture &in )", asFUNCTION( ( as::BindingHelper::constructor<Texture,const Texture &> ) ), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// Copy Assignement
		r = engine->RegisterObjectMethod( "Texture","Texture& opAssign(const Texture &in)", asFUNCTION((as::BindingHelper::opAssign<Texture&,Texture,Texture&>)), asCALL_CDECL_OBJLAST); assert( r >= 0 );
		...
		r = engine->RegisterObjectBehaviour( "Texture", asBEHAVE_CONSTRUCT,
			"void f( int aWidth, int aHeight, gl::Texture::Format format = gl::Texture::Format() )", asFUNCTION( ( as::BindingHelper::constructor<Texture,int ,int ,Texture::Format > ) ), asCALL_CDECL_OBJLAST); assert( r >= 0 );
		...
		r = engine->RegisterObjectBehaviour( "Texture", asBEHAVE_CONSTRUCT,
			"void f( const Surface &in surface, gl::Texture::Format format = gl::Texture::Format() )", asFUNCTION( ( as::BindingHelper::constructor<Texture,const Surface8u &,Texture::Format > ) ), asCALL_CDECL_OBJLAST); assert( r >= 0 );

/*
		// CONSTRUCTOR: Texture( const Surface32f &surface, Format format = Format() )
		r = engine->RegisterObjectBehaviour( "Texture", asBEHAVE_CONSTRUCT,
			"void f( const Surface32f &in surface, gl::Texture::Format format = gl::Texture::Format() )", asFUNCTION( ( as::BindingHelper::constructor<Texture,const Surface32f &,Texture::Format > ) ), asCALL_CDECL_OBJLAST); assert( r >= 0 );
*/

		// CONSTRUCTOR: Texture( const Channel8u &channel, Format format = Format() )
		r = engine->RegisterObjectBehaviour( "Texture", asBEHAVE_CONSTRUCT,
			"void f( const Channel &in channel, gl::Texture::Format format = gl::Texture::Format() )", asFUNCTION( ( as::BindingHelper::constructor<Texture,const Channel8u &,Texture::Format > ) ), asCALL_CDECL_OBJLAST); assert( r >= 0 );
/*

		// CONSTRUCTOR: Texture( const Channel32f &channel, Format format = Format() )
		r = engine->RegisterObjectBehaviour( "Texture", asBEHAVE_CONSTRUCT,
			"void f( const Channel32f &in channel, gl::Texture::Format format = gl::Texture::Format() )", asFUNCTION( ( as::BindingHelper::constructor<Texture,const Channel32f &,Texture::Format > ) ), asCALL_CDECL_OBJLAST); assert( r >= 0 );


		// CONSTRUCTOR: Texture( ImageSourceRef imageSource, Format format = Format() )
		r = engine->RegisterObjectBehaviour( "Texture", asBEHAVE_CONSTRUCT,
			"void f( ImageSourceRef imageSource, gl::Texture::Format format = gl::Texture::Format() )", asFUNCTION( ( as::BindingHelper::constructor<Texture,ImageSourceRef ,Texture::Format > ) ), asCALL_CDECL_OBJLAST); assert( r >= 0 );
*/

		// CONSTRUCTOR: Texture( GLenum aTarget, GLuint aTextureID, int aWidth, int aHeight, bool aDoNotDispose )
		r = engine->RegisterObjectBehaviour( "Texture", asBEHAVE_CONSTRUCT,
			"void f( uint aTarget, uint fID, int aWidth, int aHeight, bool aDoNotDispose )", asFUNCTION( ( as::BindingHelper::constructor<Texture,GLenum ,GLuint ,int ,int ,bool > ) ), asCALL_CDECL_OBJLAST); assert( r >= 0 );
