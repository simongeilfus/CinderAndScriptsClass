...
namespace as {
	...
	void registerCinderColorTImpl( asIScriptEngine* engine, const std::string &name, const std::string &type, const std::string &suffix, bool useNamespaces )
	{
		...
		r = engine->RegisterObjectBehaviour( name.c_str(), asBEHAVE_CONSTRUCT,
			"void f()", asFUNCTION( as::BindingHelper::constructor<ColorT<T>>), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// Destructor
		r = engine->RegisterObjectBehaviour( name.c_str(), asBEHAVE_DESTRUCT,
			"void f()", asFUNCTION(as::BindingHelper::destructor<ColorT<T>>), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// Copy Constructor
		r = engine->RegisterObjectBehaviour( name.c_str(), asBEHAVE_CONSTRUCT,
			( "void f(const " + name + " &in )" ).c_str(), asFUNCTION( ( as::BindingHelper::constructor<ColorT<T>,const ColorT<T> &> ) ), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// Copy Assignement
		r = engine->RegisterObjectMethod( name.c_str(), ( name + " & opAssign(const " + name + " &in)" ).c_str(), asFUNCTION((as::BindingHelper::opAssign<ColorT<T>&,ColorT<T>,const ColorT<T>&>)), asCALL_CDECL_OBJLAST); assert( r >= 0 );
		...
		r = engine->RegisterObjectBehaviour( name.c_str(), asBEHAVE_CONSTRUCT,
			std::string( "void f( " + type + " aR, " + type + " aG, " + type + " aB )" ).c_str(), asFUNCTION( ( as::BindingHelper::constructor<ColorT<T>,T ,T ,T > ) ), asCALL_CDECL_OBJLAST); assert( r >= 0 );
		...
		r = engine->RegisterObjectBehaviour( name.c_str(), asBEHAVE_CONSTRUCT,
			std::string( "void f( int cm, const Vec3f &in v )" ).c_str(), asFUNCTION( ( as::BindingHelper::constructor<ColorT<T>,ColorModel ,const Vec3f &> ) ), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// CONSTRUCTOR: ColorT( int cm, float x, float y, float z )
		/*r = engine->RegisterObjectBehaviour( name.c_str(), asBEHAVE_CONSTRUCT,
			std::string( "void f( int cm, float x, float y, float z )" ).c_str(), asFUNCTION( ( as::BindingHelper::constructor<ColorT<T>,ColorModel ,float ,float ,float > ) ), asCALL_CDECL_OBJLAST); assert( r >= 0 );
*/
		...
		r = engine->RegisterObjectMethod(name.c_str(), std::string( name + " opAdd( const " + name + " &in rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opAdd<ColorT<T>,ColorT<T>,const ColorT<T> &>)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: ColorT<T> operator-( const ColorT<T> &rhs ) const
		r = engine->RegisterObjectMethod(name.c_str(), std::string( name + " opSub( const " + name + " &in rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opSub<ColorT<T>,ColorT<T>,const ColorT<T> &>)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: ColorT<T> operator*( const ColorT<T> &rhs ) const
		r = engine->RegisterObjectMethod(name.c_str(), std::string( name + " opMul( const " + name + " &in rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opMul<ColorT<T>,ColorT<T>,const ColorT<T> &>)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: ColorT<T> operator/( const ColorT<T> &rhs ) const
		r = engine->RegisterObjectMethod(name.c_str(), std::string( name + " opDiv( const " + name + " &in rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opDiv<ColorT<T>,ColorT<T>,const ColorT<T> &>)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: const ColorT<T>& operator+=( const ColorT<T> &rhs )
		r = engine->RegisterObjectMethod(name.c_str(), std::string( "const " + name + "& opAddAssign( const " + name + " &in rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opAddAssign<const ColorT<T>&,ColorT<T>,const ColorT<T> &>)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: const ColorT<T>& operator-=( const ColorT<T> &rhs )
		r = engine->RegisterObjectMethod(name.c_str(), std::string( "const " + name + "& opSubAssign( const " + name + " &in rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opSubAssign<const ColorT<T>&,ColorT<T>,const ColorT<T> &>)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: const ColorT<T>& operator*=( const ColorT<T> &rhs )
		r = engine->RegisterObjectMethod(name.c_str(), std::string( "const " + name + "& opMulAssign( const " + name + " &in rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opMulAssign<const ColorT<T>&,ColorT<T>,const ColorT<T> &>)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: const ColorT<T>& operator/=( const ColorT<T> &rhs )
		r = engine->RegisterObjectMethod(name.c_str(), std::string( "const " + name + "& opDivAssign( const " + name + " &in rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opDivAssign<const ColorT<T>&,ColorT<T>,const ColorT<T> &>)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: ColorT<T> operator+( T rhs ) const
		r = engine->RegisterObjectMethod(name.c_str(), std::string( name + " opAdd( " + type + " rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opAdd<ColorT<T>,ColorT<T>,T >)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: ColorT<T> operator-( T rhs ) const
		r = engine->RegisterObjectMethod(name.c_str(), std::string( name + " opSub( " + type + " rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opSub<ColorT<T>,ColorT<T>,T >)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: ColorT<T> operator*( T rhs ) const
		r = engine->RegisterObjectMethod(name.c_str(), std::string( name + " opMul( " + type + " rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opMul<ColorT<T>,ColorT<T>,T >)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: ColorT<T> operator/( T rhs ) const
		r = engine->RegisterObjectMethod(name.c_str(), std::string( name + " opDiv( " + type + " rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opDiv<ColorT<T>,ColorT<T>,T >)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: const ColorT<T>& operator+=( T rhs )
		r = engine->RegisterObjectMethod(name.c_str(), std::string( "const " + name + "& opAddAssign( " + type + " rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opAddAssign<const ColorT<T>&,ColorT<T>,T >)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: const ColorT<T>& operator-=( T rhs )
		r = engine->RegisterObjectMethod(name.c_str(), std::string( "const " + name + "& opSubAssign( " + type + " rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opSubAssign<const ColorT<T>&,ColorT<T>,T >)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: const ColorT<T>& operator*=( T rhs )
		r = engine->RegisterObjectMethod(name.c_str(), std::string( "const " + name + "& opMulAssign( " + type + " rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opMulAssign<const ColorT<T>&,ColorT<T>,T >)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: const ColorT<T>& operator/=( T rhs )
		r = engine->RegisterObjectMethod(name.c_str(), std::string( "const " + name + "& opDivAssign( " + type + " rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opDivAssign<const ColorT<T>&,ColorT<T>,T >)), asCALL_CDECL_OBJLAST); assert( r >= 0 );
	...
	void registerCinderColorATImpl( asIScriptEngine* engine, const std::string &name, const std::string &type, const std::string &suffix, bool useNamespaces )
	{
		...
		// Default Constructor
		r = engine->RegisterObjectBehaviour( name.c_str(), asBEHAVE_CONSTRUCT,
			"void f()", asFUNCTION( as::BindingHelper::constructor<ColorAT<T>>), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// Destructor
		r = engine->RegisterObjectBehaviour( name.c_str(), asBEHAVE_DESTRUCT,
			"void f()", asFUNCTION(as::BindingHelper::destructor<ColorAT<T>>), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// Copy Constructor
		r = engine->RegisterObjectBehaviour( name.c_str(), asBEHAVE_CONSTRUCT,
			( "void f(const " + name + " &in )" ).c_str(), asFUNCTION( ( as::BindingHelper::constructor<ColorAT<T>,const ColorAT<T> &> ) ), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// Copy Assignement
		r = engine->RegisterObjectMethod( name.c_str(), ( name + " & opAssign(const " + name + " &in)" ).c_str(), asFUNCTION((as::BindingHelper::opAssign<ColorAT<T>&,ColorAT<T>,const ColorAT<T>&>)), asCALL_CDECL_OBJLAST); assert( r >= 0 );
		...
		r = engine->RegisterObjectBehaviour( name.c_str(), asBEHAVE_CONSTRUCT,
			std::string( "void f( " + type + " aR, " + type + " aG, " + type + " aB, " + type + " aA )" ).c_str(), asFUNCTION( ( as::BindingHelper::constructor<ColorAT<T>,T ,T ,T ,T > ) ), asCALL_CDECL_OBJLAST); assert( r >= 0 );
		...
		r = engine->RegisterObjectBehaviour( name.c_str(), asBEHAVE_CONSTRUCT,
			std::string( "void f( const Color &in col, " + type + " aA )" ).c_str(), asFUNCTION( ( as::BindingHelper::constructor<ColorAT<T>,const ColorT<T> &,T > ) ), asCALL_CDECL_OBJLAST); assert( r >= 0 );
		...
		/*r = engine->RegisterObjectBehaviour( name.c_str(), asBEHAVE_CONSTRUCT,
			std::string( "void f( int cm, float c1, float c2, float c3, float aA = 1.0f )" ).c_str(), asFUNCTION( ( as::BindingHelper::constructor<ColorAT<T>,ColorModel ,float ,float ,float ,float > ) ), asCALL_CDECL_OBJLAST); assert( r >= 0 );*/
		...
		r = engine->RegisterObjectMethod(name.c_str(), std::string( name + " opAdd( const " + name + " &in rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opAdd<ColorAT<T>,ColorAT<T>,const ColorAT<T> &>)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: ColorAT<T> operator-( const ColorAT<T> &rhs ) const
		r = engine->RegisterObjectMethod(name.c_str(), std::string( name + " opSub( const " + name + " &in rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opSub<ColorAT<T>,ColorAT<T>,const ColorAT<T> &>)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: ColorAT<T> operator*( const ColorAT<T> &rhs ) const
		r = engine->RegisterObjectMethod(name.c_str(), std::string( name + " opMul( const " + name + " &in rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opMul<ColorAT<T>,ColorAT<T>,const ColorAT<T> &>)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: ColorAT<T> operator/( const ColorAT<T> &rhs ) const
		r = engine->RegisterObjectMethod(name.c_str(), std::string( name + " opDiv( const " + name + " &in rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opDiv<ColorAT<T>,ColorAT<T>,const ColorAT<T> &>)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: const ColorAT<T>& operator+=( const ColorAT<T> &rhs )
		r = engine->RegisterObjectMethod(name.c_str(), std::string( "const " + name + "& opAddAssign( const " + name + " &in rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opAddAssign<const ColorAT<T>&,ColorAT<T>,const ColorAT<T> &>)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: const ColorAT<T>& operator-=( const ColorAT<T> &rhs )
		r = engine->RegisterObjectMethod(name.c_str(), std::string( "const " + name + "& opSubAssign( const " + name + " &in rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opSubAssign<const ColorAT<T>&,ColorAT<T>,const ColorAT<T> &>)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: const ColorAT<T>& operator*=( const ColorAT<T> &rhs )
		r = engine->RegisterObjectMethod(name.c_str(), std::string( "const " + name + "& opMulAssign( const " + name + " &in rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opMulAssign<const ColorAT<T>&,ColorAT<T>,const ColorAT<T> &>)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: const ColorAT<T>& operator/=( const ColorAT<T> &rhs )
		r = engine->RegisterObjectMethod(name.c_str(), std::string( "const " + name + "& opDivAssign( const " + name + " &in rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opDivAssign<const ColorAT<T>&,ColorAT<T>,const ColorAT<T> &>)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: ColorAT<T> operator+( T rhs ) const
		r = engine->RegisterObjectMethod(name.c_str(), std::string( name + " opAdd( " + type + " rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opAdd<ColorAT<T>,ColorAT<T>,T >)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: ColorAT<T> operator-( T rhs ) const
		r = engine->RegisterObjectMethod(name.c_str(), std::string( name + " opSub( " + type + " rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opSub<ColorAT<T>,ColorAT<T>,T >)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: ColorAT<T> operator*( T rhs ) const
		r = engine->RegisterObjectMethod(name.c_str(), std::string( name + " opMul( " + type + " rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opMul<ColorAT<T>,ColorAT<T>,T >)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: ColorAT<T> operator/( T rhs ) const
		r = engine->RegisterObjectMethod(name.c_str(), std::string( name + " opDiv( " + type + " rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opDiv<ColorAT<T>,ColorAT<T>,T >)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: const ColorAT<T>& operator+=( T rhs )
		r = engine->RegisterObjectMethod(name.c_str(), std::string( "const " + name + "& opAddAssign( " + type + " rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opAddAssign<const ColorAT<T>&,ColorAT<T>,T >)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: const ColorAT<T>& operator-=( T rhs )
		r = engine->RegisterObjectMethod(name.c_str(), std::string( "const " + name + "& opSubAssign( " + type + " rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opSubAssign<const ColorAT<T>&,ColorAT<T>,T >)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: const ColorAT<T>& operator*=( T rhs )
		r = engine->RegisterObjectMethod(name.c_str(), std::string( "const " + name + "& opMulAssign( " + type + " rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opMulAssign<const ColorAT<T>&,ColorAT<T>,T >)), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// OPERATOR: const ColorAT<T>& operator/=( T rhs )
		r = engine->RegisterObjectMethod(name.c_str(), std::string( "const " + name + "& opDivAssign( " + type + " rhs )" ).c_str(), asFUNCTION((as::BindingHelper::opDivAssign<const ColorAT<T>&,ColorAT<T>,T >)), asCALL_CDECL_OBJLAST); assert( r >= 0 );
