...
namespace as {
	...
	void registerCinderTriMeshImpl( asIScriptEngine* engine, bool useNamespaces )
	{
		...
		r = engine->RegisterObjectBehaviour( "TriMesh", asBEHAVE_CONSTRUCT,
			"void f()", asFUNCTION( as::BindingHelper::constructor<TriMesh>), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// Destructor
		r = engine->RegisterObjectBehaviour( "TriMesh", asBEHAVE_DESTRUCT,
			"void f()", asFUNCTION(as::BindingHelper::destructor<TriMesh>), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// Copy Constructor
		r = engine->RegisterObjectBehaviour( "TriMesh", asBEHAVE_CONSTRUCT,
			"void f(const TriMesh &in )", asFUNCTION( ( as::BindingHelper::constructor<TriMesh,const TriMesh &> ) ), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// Copy Assignement
		r = engine->RegisterObjectMethod( "TriMesh","TriMesh& opAssign(const TriMesh &in)", asFUNCTION((as::BindingHelper::opAssign<TriMesh&,TriMesh,TriMesh&>)), asCALL_CDECL_OBJLAST); assert( r >= 0 );
...
*/
	...
	void registerCinderTriMesh2dImpl( asIScriptEngine* engine, bool useNamespaces )
	{
		...
		r = engine->RegisterObjectBehaviour( "TriMesh2d", asBEHAVE_CONSTRUCT,
			"void f()", asFUNCTION( as::BindingHelper::constructor<TriMesh2d>), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// Destructor
		r = engine->RegisterObjectBehaviour( "TriMesh2d", asBEHAVE_DESTRUCT,
			"void f()", asFUNCTION(as::BindingHelper::destructor<TriMesh2d>), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// Copy Constructor
		r = engine->RegisterObjectBehaviour( "TriMesh2d", asBEHAVE_CONSTRUCT,
			"void f(const TriMesh2d &in )", asFUNCTION( ( as::BindingHelper::constructor<TriMesh2d,const TriMesh2d &> ) ), asCALL_CDECL_OBJLAST); assert( r >= 0 );

		// Copy Assignement
		r = engine->RegisterObjectMethod( "TriMesh2d","TriMesh2d& opAssign(const TriMesh2d &in)", asFUNCTION((as::BindingHelper::opAssign<TriMesh2d&,TriMesh2d,TriMesh2d&>)), asCALL_CDECL_OBJLAST); assert( r >= 0 );
